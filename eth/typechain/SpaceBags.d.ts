...
interface SpaceBagsInterface extends ethers.utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "bagsAmount(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "bagsAmount", data: BytesLike): Result;
  ...
  events: {
    ...
    "Pack(address,uint256,uint256)": EventFragment;
    "Transfer(address,address,uint256)": EventFragment;
    "Unpack(address,uint256,uint256)": EventFragment;
  };
...
export type PackEvent = TypedEvent<
...
export class SpaceBags extends BaseContract {
  ...
  bagsAmount(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    pack(amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    unpack(tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "Pack(address,uint256,uint256)"(
      staker?: string | null,
      amount?: null,
      tokenId?: null
    ): TypedEventFilter<
      [string, BigNumber, BigNumber],
      { staker: string; amount: BigNumber; tokenId: BigNumber }
    >;
    ...
    "Unpack(address,uint256,uint256)"(
      staker?: string | null,
      amount?: null,
      tokenId?: null
    ): TypedEventFilter<
